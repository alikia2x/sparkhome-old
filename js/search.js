...
function write_engine_list() {
    ...
    if (check_extra_engine()) {
        ...
        document.getElementById("search_engine").innerHTML = '<a value="baidu" onclick="engine_change(\'baidu\')">百度</a><a value="bing" onclick="engine_change(\'bing\')">必应</a><a value="google" onclick="engine_change(\'google\')">谷歌</a>'
        + html;
    } else {
        document.getElementById("search_engine").innerHTML = '<a value="baidu" onclick="engine_change(\'baidu\')">百度</a><a value="bing" onclick="engine_change(\'bing\')">必应</a><a value="google" onclick="engine_change(\'google\')">谷歌</a>'
    }
